...
namespace JuanGallardo_Exam1P.Controllers
{
    public class JGmodel1Controller : Controller
    {
        private readonly JuanGallardo_Exam1PContext _context;

        public JGmodel1Controller(JuanGallardo_Exam1PContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("JGmodel1ID,Name,Price,Contrasenia,Edad,CreatedDate")] JGmodel1 jGmodel1)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JGmodel1ID,Name,Price,Contrasenia,Edad,CreatedDate")] JGmodel1 jGmodel1)
        {
